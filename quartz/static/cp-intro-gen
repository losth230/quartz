// ============================================================
//  C&P — Générateur d'introduction narrative (LLM)
//  À placer dans : quartz/static/cp-intro-gen.js
//  Saisie des camps + ambiance -> appel Edge Function -> texte d'intro.
...
// (visible dans l'URL de ton client : https://<TON-PROJET>.supabase.co)
const EDGE_URL = "https://kucgmmefluwmlobujanc.supabase.co/functions/v1/generer-intro";
...
async function generer() {
  ...
  if (factions.length < 2) {
    ...
    msg.textContent = "Choisis au moins deux factions.";
    return;
  }
