## Description
Les **Revenants** sont des guerriers ou des mages qui ont pactisé avec le **Royaume des Racines**, un domaine de l'au-delà où les âmes des morts résident. Grâce à cet accord, ils ont accès à des pouvoirs de nécromancie et à des capacités uniques, leur permettant soit de ramener des guerriers morts à la vie pour se battre à leurs côtés, soit de se battre eux-mêmes en puisant dans leur lien avec le royaume des morts.

Les Revenants sont des créatures de l’ombre, tiraillées entre la vie et la mort. Bien que puissants, ils sont souvent maudits, leur âme étant partiellement prisonnière de ce royaume spectral.
...
##### Pas de l'ombre
Vous pouvez dépenser un dé de votre réserve de magie pour vous téléporter sur une distance de 6m. Cette compétence n'est utilisable qu'une fois par tour.
...
## Niveau 7
##### La voie des Racines
Lorsque vous atteignez le niveau 7, vous pouvez choisir l'Enseignement de Mage de votre choix.
## Niveau 10
##### Charge du fond du monde
A partir du niveau 10, lorsque vous ou une de vos invocation Cadavérique réussit une charge sur une distance de 7m ou plus, l'attaque gratuite  octroyée bénéficie d'un bonus de Force Dévastatrice (+1), si la  distance est de 11m ou plus, l'attaque  gratuite  octroyée bénéficie d'un bonus de Force Dévastatrice (+2).
## Niveau 12
##### Forme Ethérée
...
A partir du niveau 2, vous pouvez faire appel aux pouvoirs de Weißroth une fois par jour pour placer une *Marque Blanche* sur une créature à 9m ou moins. Chaque fois qu'un 6 est obtenu pour un jet d'attaque contre cette créature, elle subit 1 fatigue.
##### Purulence (niveau 5)
...
Chaque fois que vous infligez au moins une blessure lors d'une attaque en mêlée, vous récupérez 1 PV si votre cible possède une *Marque Blanche*.
...
A partir du niveau 2, vous pouvez dépenser votre réaction pour invoquer un Zombie à 6m ou moins et le faire jouer immédiatement. Cette compétence n'est réutilisable qu'après un repos.
##### Contrôle d'esprit (niveau 2)
A partir du niveau 2, une fois par jour, vous pouvez dépenser une action courte pour octroyer une action courte à l'une de vos invocations Cadavérique.
##### Danse macabre (niveau 5)
A partir du niveau 5, vos invocations Cadavériques ont +1d6 en mêlée.
##### Domination (niveau 8)
...
A partir du niveau 11, vos invocations Cadavériques ont +1 Vitesse.
...
A partir du niveau 2, vous gagnez la maitrise des armures lourdes.
##### Parade (niveau 2)
A partir du niveau 2, après avoir subit des touches en mêlée mais avant d'effectuer vos jets d'armure, vous pouvez annuler un nombre de touches égales à votre niveau. Si votre niveau est supérieur au nombre de touches que vous avez subies, l'attaquant reçoit un nombre de touche égal à la différence auxquelles s'applique la [[Règles/Règles spéciales#force dévastatrice(N)|force dévastatrice]] de votre arme.
##### Retour d'outre-tombe (niveau 5)
A partir du niveau 5, vous pouvez dépenser votre réaction et 1 dé de magie par niveau du sort pour renvoyer un sort vous prenant pour cible à son envoyeur.
##### Aura de désespoir (niveau 8)
A partir du niveau 8, les créatures hostiles à 3m ou moins subissent un malus de -1 vitesse et -1 à leurs tests de Résilience.
