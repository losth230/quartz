<!-- ============================================================
     ...
     Suivi des signalements. HTML + CSS (variables Quartz).
     JS dans /quartz/static/cp-bug-tracker.js
     ============================================================ -->
...
<div id="cp-bug-app">
  <style>
    ...
    #cp-bug-app * { box-sizing: border-box; }
    #cp-bug-app h2 {
    ...
    .ty-bug         { color: #b5524a; }   /* rouge   : bug */
    .ty-equilibrage { color: #8a5cb5; }   /* violet  : équilibrage */
    .ty-idee        { color: #3a8a4a; }   /* vert    : idée */
    .ty-regle       { color: #2f72b5; }   /* bleu    : règle peu claire */
    .ty-autre       { color: var(--gray); } /* neutre : autre */
  ...
  <h2>Signalements</h2>
  <p class="cp-intro">Tous les problèmes remontés par les joueurs. Clique une ligne pour lire le détail, le crayon pour modifier, le menu pour changer l'état.</p>
