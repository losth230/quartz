...
##### Compétences de base
Lorsque vous créez un Revenant, choisissez :
...
##### Pas de l'ombre
Vous pouvez dépenser un dé de votre réserve de magie pour vous téléporter sur une distance de 6''. Cette compétence n'est utilisable qu'une fois par tour.
...
Une fois par jour, vous pouvez dépenser une action courte pour octroyer une action courte à l'une de vos invocations Cadavérique.
